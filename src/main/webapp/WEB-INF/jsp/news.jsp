...
<div class="container success">
	<h3 class="mt-50 text-center">News</h3>
	<div class="row">
		<div class="col-lg-9">
			<div class="blog-item clearfix">
				<img src="http://placehold.it/871x401" alt="blog-single"
					class="resp-img">
				<h3>Creative webdesign workshop 2017</h3>
				<div class="author">
					<a href="#">WEBDESIGN</a><span> - 4 JANUARY 2016 BY JONATHAN
						DOE</span>
				</div>
				<p class="abs">Lorem ipsum dolor sit amet, consetetur sadipscing
			...
			<div class="paginations">
				...
				<a href="#">5</a> <a href="#">6</a> <a class="next" href="#">NEXT<i
					class="zmdi zmdi-chevron-right"></i></a>
			</div>
		</div>
		<div class="col-lg-3 blog-sidebar">
			<div class="search-something">
				<input type="search" placeholder="search for something"> <a
					href="#"><i class="zmdi zmdi-search"></i></a>
			</div>
			<h4>RECENT POSTS</h4>
			...
			<ul class="instagram-feed">
				<li><a href="#"></a><img alt="instagram image"
					src="http://placehold.it/62x61"></li>
				<li><a href="#"></a><img alt="instagram image"
					src="http://placehold.it/62x61"></li>
				<li><a href="#"></a><img alt="instagram image"
					src="http://placehold.it/62x61"></li>
