...
<body>
	...
	<div class="chat-box">
		...
		<div>
			...
			<%-- <form:form action="adminToSender" method="post" modelAttribute="chat">
 --%>
				<input type="text" class="mytext" placeholder="Type a message"
					name="message" />
			<%-- 	<form:input type="hidden" class="write_msg" placeholder="receiverId"
					value="1" path="receiverId" />
 ...
 --%>
	...
	<script type="text/javascript">
		...
		setInterval(function(){onpagelLoad();}, 100);
	</script>
