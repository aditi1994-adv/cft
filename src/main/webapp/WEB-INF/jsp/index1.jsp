    ...
    <body  onload="onpagelLOad()">
        <div class="col-sm-3 col-sm-offset-4 frame">
            ...
            <div>
              ...
              <form:input type="text"   class="mytext"  placeholder="Type a message"   path="message"/>
              <form:input type="hidden" class="write_msg" placeholder="SenderId"  value="1"   path="senderId"/>
             <form:input type="hidden" class="write_msg" placeholder="SenderId"  value="1"   path="receiverId"/>
              <button class="msg_send_btn" type="submit"><i class="fa fa-paper-plane-o" aria-hidden="true"></i>receiver</button>
