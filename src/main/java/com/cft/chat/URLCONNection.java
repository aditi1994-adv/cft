...
public class URLCONNection {
	public static String getText(String url)throws Exception
	{
		StringBuilder response=new StringBuilder();
		 ...
		 connection.setRequestProperty("SOAPAction","https://tempuri.org/GetStudentDetails");
...
//			cgiInput.writeBytes(keyPair);
	...
	public static String  callHttpsPostNew(String API_URL,String acccessToken)
	{
		String response = "";
		...
		try 
		{
			...
			httpsCon.setRequestProperty("Host", "api.linkedin.com");
			httpsCon.setRequestProperty("Connection", "Keep-Alive");
			httpsCon.setRequestProperty("Authorization", "Bearer "+	acccessToken);
